...
* Request
  * Method: POST
  * URL: '/spots/:spotId/reviews/:reviewId/images/add'
  * Headers:
    * Content-Type: application/json
  * Body:
...
* Request
  * Method: PUT
  * URL: 'spots/:spotId/reviews/:reviewId/edit'
  * Headers:
    * Content-Type: application/json
  * Body:
...
* Request
  * Method: DELETE
  * URL: '/spots/:spotId/reviews/:reviewId/delete'
  * Body: none
...
* Request
  * Method: PUT
  * URL: 'spots/:spotId/bookings/:bookingId/edit'
  * Headers:
    * Content-Type: application/json
  * Body:
...
* Request
  * Method: DELETE
  * URL: '/spots/:spotId/bookings/:bookingId/delete'
  * Body: none
...
* Request
  * Method: DELETE
  * URL: 'spots/:spotId/images/:imageId/delete'
  * Body: none
...
* Request
  * Method: DELETE
  * URL: 'spots/:spotId/reviews/images/:imageId/delete'
  * Body: none
